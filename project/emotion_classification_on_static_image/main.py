...
if __name__ == '__main__':
    ...
    parser.add_argument('-stamp', default='lr1e3_bs128', type=str, help='To indicate different experiment instances') # pretrain_ResVIZ
    ...
    parser.add_argument('-use_weighted_sampler', default=0, type=int, help='Whether to balance the samples of each classes using weighted sampler?')
