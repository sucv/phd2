...
if __name__ == '__main__':
    ...
    parser.add_argument('-stamp', default='final_correct', type=str, help='To indicate different experiment instances')
    ...
    parser.add_argument('-cnn1d_channels', default=[128], nargs="+", type=int, help='The specific epochs to do something.')
